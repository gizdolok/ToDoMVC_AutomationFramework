...
/*    public static ToDosListCommand LoginAs(String userName)
    {
        DriverSingleton.finishLocatorPresent(usernameLocator);
        return new LoginCommand(userName);
    }

    public static Boolean successMessagePresent(){
        DriverSingleton.finishLocatorPresent(successMessageLocator);
        return DriverSingleton.isDisplayed(successMessageLocator); }

    public static Boolean failureMessagePresent(){
        DriverSingleton.finishLocatorPresent(failureMessageLocator);
        return DriverSingleton.isDisplayed(failureMessageLocator); }
    ...
    public static class LoginCommand
    {
        ...
        public void Login()
        {
            DriverSingleton.finishLocatorPresent(loginFormLocator);
            DriverSingleton.type(userName, usernameLocator);
            DriverSingleton.type(password, passwordLocator);
            DriverSingleton.click(submitButtonLocator);
        }
    }*/
}
